...
function check(){
	...
	} else if( email.indexOf("select") > -1 || email.indexOf("SELECT") > -1 || email.indexOf("where") > -1 || email.indexOf("WHERE") > -1) {
		dodajInfo("Sql injection? Not this time.", 'email_err', 'email_msg');
	} else if( email.indexOf("document") > -1 || email.indexOf("script") > -1 || email.indexOf("onclick") > -1 || email.indexOf("onload") > -1) {
		dodajInfo("XSS? Not this time.", 'email_err', 'email_msg');
